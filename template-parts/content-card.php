 <div class="col-12 col-md-6 col-lg-4 h-2900r d-flex flex-column justify-content-end">
    <div class="position-relative shadow rounded-25 h-1950r d-flex flex-column justify-content-end p-4">
        ...
        <div class="position-absolute top-78 start-50 translate-middle w-85 h-28 overflow-hidden">
            <a href="<?php echo get_post_permalink(); ?>" class="text-dark">
                <h2 class="fs-90r fw-bold"><?php the_title(); ?></h2>
            </a>
            <div class="fs-70r m-0">
                <?php echo mb_strimwidth(the_content(), 0, 190, '...'); ?>
            </div>
        </div>
    </div>
 </div>
